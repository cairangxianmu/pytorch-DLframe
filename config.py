...
_C.DATA.DATA_PATH = '../../data/BHSig260/'
# Dataset name
_C.DATA.DATASET = 'BHSig_H'
# Input image size
...
# Label Smoothing
_C.MODEL.LABEL_SMOOTHING = 0. #0.1
